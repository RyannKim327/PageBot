...
export default (api, event) => {
  const data = JSON.parse(fs.readFileSync(`${__dirname}/data/auto_user.json`, "utf-8"))
  ...
  fs.writeFileSync(`${__dirname}/data/auto_user.json`, JSON.stringify(data, null, 2), 'utf-8')
};
